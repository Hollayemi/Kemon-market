    ...
    <button class="close_nav" onclick="toggleNav()"><img src="material/close@2x.png" alt=""></button><br><br>
      ...
      <div>
          <ul class="anchors anchors22">
            ...
            <li><a href="pic/my_pic.jpg"><img src="pic/my_pic.jpg" alt="" height='50' width='50' style="border-radius:100%"></a></li>
            <li><a href="#"><button><?php echo 'Stephan'?><i class="fa fa-angle-up"></i></button></a></li>
          </ul>
      </div>
