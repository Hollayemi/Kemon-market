...
?>
 ...
 <div class="reg_btn">
			...
			<div >
				...
				<form method="POST" autocomplete="off">
                 <h2 style="color:black;">Company Details</h2>
                  ...
                  <div class="inputs">
                      <input type="file" name="mypic" value="" style="padding:10px;" required>
                  </div><br>        
           </div>
            <div class="inputs">
  ...
  <section onload="showscroll()" class='show-up'>
    <div>
      <h4>Holla</h4>
    </div>
  </section>
  ...
  <script>
    function showscroll(){
      document.querySelector(".show-up").classList.toggle("show--open");
    }
