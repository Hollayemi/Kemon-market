...
<div class="PaymentsPage" style="color:red;text-align:center;margin-top:10em">
    <h2>Hi, <?php echo $_SESSION['username']; ?>, continue your subscribtion by pressing</h2>
    <form action="" method="POST">
        <script src="https://js.paystack.co/v1/inline.js"></script>
        <button name="sub" type="button" onclick="payPageWithPaystack()"> Proceed transaction </button> 
    </form>
</div>
 <?php
 $first_name = "love";
